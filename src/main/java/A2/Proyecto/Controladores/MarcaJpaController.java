 ...
 */
package A2.Proyecto.Controladores;

import A2.Proyecto.Controladores.exceptions.NonexistentEntityException;
import A2.Proyecto.Controladores.exceptions.PreexistingEntityException;
import A2.Proyecto.Entidades.Marca;
...
public class MarcaJpaController implements Serializable {
    ...
    public void create(Marca marca) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findMarca(marca.getCodigo()) != null) {
    ...
    public Marca findMarca(String id) {
        EntityManager em = getEntityManager();
        try {
